  ...
  <div class="container mx-auto px-6 py-8">
    ...
    <div class="flex flex-col mt-8">
      <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        <div
          class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200 dark:border-gray-900"
        >
          <table class="min-w-full">
            <thead>
              <tr>
                <th
                  class="px-6 py-3 border-b border-gray-200 dark:border-gray-900 bg-gray-50 dark:bg-gray-900 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider"
                >
                  Name
                </th>
                <th
                ...
                <th
                  class="px-6 py-3 border-b border-gray-200 dark:border-gray-900 bg-gray-50 dark:bg-gray-900"
                ></th>
              </tr>
            </thead>
            ...
            <tbody class="bg-white dark:bg-gray-800">
              <tr v-for="i in 10" :key="i">
                ...
                <td
                  class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 dark:border-gray-900 text-sm leading-5 text-gray-500"
                >
                  Owner
                </td>

                <td
                  class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 dark:border-gray-900 text-sm leading-5 font-medium"
                >
